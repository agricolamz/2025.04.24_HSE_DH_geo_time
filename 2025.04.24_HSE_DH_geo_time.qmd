...
Если вы работаете с данными маленьких расстояний (особенно близкими к экватору), широту и долготу можно без страха использовать как оси в декартовой системе координат. Однако при работе с данными масштаба страны/континента/планеты такой подход не сможет игнорировать накопившуюся ошибку из-за искажений одного из следующих типов:
